...
namespace EmployeeDetails.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EmpId,EmpName,EmpPhone,EmpEmail,DOB,JobTitle,Department")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("EmpId,EmpName,EmpPhone,EmpEmail,DOB,JobTitle,Department")] Employee employee)
        {
